...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            if (vezUsuarioJogar == true) {
                ...
                // Modificado por João Victor² | if (teveGanhador == true) -> if
                ...
                // Modificado por João Victor² | if (teveGanhador == true) -> if
                // (teveGanhador(caractereComputador))
    ...
    // espaço, no início do jogo. Matrizes de char precisam ter um valor diferente
    // de '' vazio.
    ...
    // procurei uma forma de transformar as letras em maiusculas e achei esse
    // toupperCase.
    ...
    static boolean teveGanhadorColuna(char caractereJogador) {
        ...
        for (int linha = 0; linha < tabuleiro.length; linha++) {
            for (int coluna = 0; coluna < tabuleiro[linha].length; coluna++) {
                if ((tabuleiro[0][coluna] == caractereJogador) && (tabuleiro[1][coluna] == caractereJogador)
                        && (tabuleiro[2][coluna] == caractereJogador)) {
                    return true;
                }
            }
        }
    ...
    static boolean teveGanhadorDiagonalPrincipal(char caractereJogador) {
        ...
        return tabuleiro[0][0] == caractereJogador && tabuleiro[1][1] == caractereJogador
    ...
    static boolean teveGanhadorDiagonalSecundaria(char caractereJogador) {
        ...
        return tabuleiro[2][0] == caractereJogador && tabuleiro[1][1] == caractereJogador
                && tabuleiro[0][2] == caractereJogador;
    }
